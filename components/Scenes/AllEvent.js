...
export default class AllEvent extends React.Component {
    ...
    componentDidMount() {
        ...
        //let url = 'https://www.thesportsdb.com/api/v1/json/1/search_all_seasons.php?id='+this.props.Id;
        let url = '  https://www.thesportsdb.com/api/v1/json/1/search_all_seasons.php?id=4334'
